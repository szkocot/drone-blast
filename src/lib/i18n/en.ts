...
export const en = {
  ...
  confirmCustomLocation: 'Confirm custom location',
  useCurrentView: 'Use current view',
  overlayRateLimit: 'Wind overlay temporarily unavailable — weather API limit exceeded. Try again shortly.',
  couldNotLoadOverlay: 'Could not load overlay.',
